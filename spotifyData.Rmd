...
clusplot(datosContEscalados, clusters5.datosContEscalados_PCA, color=TRUE, shade=TRUE, labels=2,lines=0)
```
...
clusplot(datosCont, clusters4.datosCont_PCA, color=TRUE, shade=TRUE, labels=2,lines=0)
```
